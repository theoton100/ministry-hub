      ...
      <section className="bg-gradient-to-b from-foreground to-foreground/90 text-background py-20 md:py-28">
        <div className="container text-center">
          <motion.div initial="hidden" animate="visible" variants={fadeUp}>
            <p className="text-primary font-medium tracking-widest uppercase text-sm mb-3">Newsletter</p>
              ...
              <Card className="shadow-xl border-border/50">
                <CardContent className="p-8 md:p-10">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <Button type="submit" className="w-full bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg" size="lg" disabled={subscribe.isPending}>
      ...
      <section className="py-16 md:py-20 bg-warm-50">
        <div className="container max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: Heart, title: "Weekly Devotionals", desc: "Short, powerful devotionals to start your week with faith and encouragement." },
              { icon: BookOpen, title: "Blog Highlights", desc: "The best articles and teachings from our blog, curated just for you." },
              { icon: Headphones, title: "Sermon Updates", desc: "Be the first to know when new sermons and podcast episodes are available." },
            ].map((item) => (

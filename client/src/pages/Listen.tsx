      ...
      <section className="bg-gradient-to-b from-foreground to-foreground/90 text-background py-20 md:py-28">
        <div className="container text-center">
          <motion.div initial="hidden" animate="visible" variants={fadeUp}>
            <p className="text-primary font-medium tracking-widest uppercase text-sm mb-3">Listen</p>
        ...
        <div className="container max-w-4xl mx-auto">
          {isLoading ? (
                  ...
                  <Card className="overflow-hidden border-border/50 hover:shadow-lg transition-shadow">
                    <CardContent className="p-6 space-y-4">
                      ...
                      {!ep.spotifyEpisodeId && ep.spotifyShowUrl && (
                        <a href={ep.spotifyShowUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm text-primary hover:underline font-medium">
            ...
            <div className="text-center py-20">
              <Headphones className="h-20 w-20 text-muted-foreground/20 mx-auto mb-6" />
